        ...
        <div className="py-10">
          ...
          <main>
            <div className="mx-auto flex gap-8 max-w-7xl sm:px-6 lg:px-8">
              <Categories setCategory={setCategory} category={category} className="bg-white w-1/5 rounded-3xl shadow-xl min-h-4" />
              <AllStores setCategory={setCategory} category={category} className="p-3 w-4/5 col-span-2 min-h-4" />
            </div>
          </main>
        </div>
      </div>
